...
if (isset($_GET['qid']))
{
	...
	print "<p><label for='rpc_server_url'>" . T_("RPC Server URL (example: http://admin:password@localhost/quexs/include/limesurvey/admin/remotecontrol.php)") . "</label> <input id='rpc_server_url' name='rpc_server_url' type='text' value='{$q['rpc_server_url']}' size='100'/></p>";
