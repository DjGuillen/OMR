...
define('ADODB_DIR', dirname(__FILE__) . '\..\quexs\include\limesurvey\classes\adodb\\');
...
define('WINDOWS_PHP_EXEC', dirname(__FILE__) . '\..\..\bgrun\bgrun.exe ' . dirname(__FILE__) . '\..\..\php\php.exe');

//Temporary directory
define('TEMPORARY_DIRECTORY', dirname(__FILE__) . '\..\..\tmp');
